...
intro = pyttsx3.init()
intro.say(
    "Hey sir its the big b i am using voice recognition. which service do you want to use? i have a voice assisted web search voice assisted calculator i also have a link shortener and last but not least the voice assisted youtube search to choose one of my services just say its name"
)
intro.runAndWait()
   ...
   """ + color.eND)
    ...
    with sr.Microphone() as source:
        ...
        try:
            ...
            print(color.bLUE + "Sorry?" + color.eND)
